...
- 📋 «Мои бронирования» — список ВСЕХ активных броней с возможностью отмены ЛЮБОЙ
- 🔗 Связка Telegram ↔ VK — забронировал в одном месте, управляешь в другом
- ⏰ Напоминания за 30 минут до начала
- 📄 Пагинация в VK (если броней больше 5)
- 🗑️ Автоматическое удаление отменённых броней старше 24 часов
...
- 🗑️ Автоматическая очистка старых отменённых броней (раз в сутки)
...
| Автоочистка | Удаление отменённых броней старше 24 часов (cleanup scheduler) |
